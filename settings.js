...
global.botname = "Jiraiya" 
global.botLanguage = "default" // 𝗗𝗲𝗳𝗮𝘂𝗹𝘁 || 𝗘𝗻𝗴𝗹𝗶𝘀𝗵 || 𝗛𝗶𝗻𝗱𝗶 || 𝗔𝗿𝗮𝗯𝗶𝗰 \\
global.author = "𝙁𝙤𝙪𝙧"  
global.packname = "𝙅𝙞𝙧𝙖𝙮𝙖✯𝘽𝙊𝙏"  
global.myweb = "blank" // You can put any link 
global.waterMark = "×͜× King ✘ Four™ ✓" // Your own watermark 
global.headerText = "Jiraya by Four" // text for header of menu         
global.DocumentTitle = "MASTER⚔️FOUR" 


global.ownername = "𝖋𝖔𝖚𝖗"   // Owner name //        
global.ownernumber = ['201005773049'] 
global.socialm = "𝗜𝗻𝘀𝘁𝗮 : BLANK" // 𝗜𝗻𝘀𝘁𝗮 : || 𝗚𝗶𝘁𝗵𝘂𝗯 : || 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸 : \\
global.ytname = "YT: BLANK"   // Yt chanel name //
global.continent = "Africa" // your continent name 
global.region = "Egypt" // your country name
global.state = "kafr El-shaikh" // your state name
global.district = "blank" // your district name
global.timezone = "Eastern European" // search on google if you don't know the timezone of your country //
global.instagramId = "blank" // Your insta ID
global.email = "blank" // put your email here
...
name16 = "𝙹𝚒𝚛𝚊𝚢𝚊 𓆩×͜×𓆪ꪾ️"
name17 = "*Λ⃝ͷ🇾Λ 𓆩×͜×𓆪ꪾ*"
name18 = "*Λ⃝ͷʏΛ 𓆩×͜×𓆪ꪾ*"

//--------Random footer message-----------\\
footer1 = `𝙹𝚒𝚛𝚊𝚢𝚊ㅤꪜ⃢𝟤ㅤ𓆩×͜×𓆪ꪾ `
...
tag9 = '𝘠𝘰𝘶 𝘢𝘭𝘭 𝘴𝘩𝘰𝘶𝘭 𝘵𝘳𝘺 Jiraya❤️🍫' 
tag10 = '𝘈𝘺𝘰𝘰 Jiraya 𝘪𝘴 𝘉𝘦𝘴𝘵!!😚' 
